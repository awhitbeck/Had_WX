...
// Thu Feb  9 13:08:16 2023 by ROOT version 6.26/06
// from TTree PreSelection/PreSelection
// found on file: /Users/jsewell/Documents/ROOT_documents/EW_SUSY/CN925_WH/CN925_WH_sgino100_sget90_BB.root
//////////////////////////////////////////////////////////
...
#ifdef WHBB_cxx
WHBB::WHBB(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Users/jsewell/Documents/ROOT_documents/EW_SUSY/CN925_WH_sgino100_sget90_BB.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/Users/jsewell/Documents/ROOT_documents/EW_SUSY/CN925_WH_sgino100_sget90_BB.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/Users/jsewell/Documents/ROOT_documents/EW_SUSY/CN925_WH_sgino100_sget90_BB.root:/TreeMaker2");
...
Int_t WHBB::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t WHBB::LoadTree(Long64_t entry)
{
